...
public class candy extends JFrame {
    candy() {
    ...
    public void game_panel() {
        ...
        user_label.setText("CANDY CRUSH");
    ...
    private void game_stats() {
        ...
        JLabel best_score = new JLabel();
        JLabel total_score = new JLabel();
        JLabel Chamber_points = new JLabel();
        JLabel total_play_points = new JLabel();
        ...
        total_play_points.setText("total play points                                            " + "0");
        total_play_points.setForeground(Color.white);
        total_play_points.setFont(new Font("Inter", Font.BOLD, 10));
        total_play_points.setBounds(50, 300, 300, 100);
        ...
        best_score.setForeground(Color.white);
        best_score.setFont(new Font("Inter", Font.BOLD, 10));
        best_score.setBounds(50, 400, 300, 100);

        stat_panel.add(best_score);
        stat_panel.add(total_play_points);
