...
public class subwaysurfers extends JFrame {
    subwaysurfers() {
        this.setTitle("GAME CHAMBER");
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setResizable(false);
        this.setSize(360, 710);
    ...
    private void game_stats() {
        ...
        stat_panel.setBounds(100, 100, 300, 300);
        ...
        mission_completed.setBounds(50, 100, 300, 100);
